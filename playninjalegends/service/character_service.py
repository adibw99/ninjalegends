...
class CharacterService:
    ...
    def setPoints(
        ...
        points: Union[List[int], Dict[Element, int]],
        user: User = None,
    ):
        ...
        if isinstance(points, dict):
            points = [
                points[Element.WIND],
                points[Element.FIRE],
                points[Element.LIGHTNING],
                points[Element.WATER],
                points[Element.EARTH],
                points[Element.NOELEMENT],
            ]

        ev = self.__client.createEnvelope(
            "CharacterService.setPoints", [character, user.SessionKey, *points]
        )
